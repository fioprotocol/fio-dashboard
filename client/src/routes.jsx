...
import FioAddressTransferFinishPage from './pages/FioAddressTransferFinishPage';
import FioDomainTransferFinishPage from './pages/FioDomainTransferFinishPage';
  ...
  <MainLayout>
    <ScrollToTop>
      <Switch>
        ...
        <PrivateRoute
          path={ROUTES.FIO_ADDRESS_TRANSFER_FINISH}
          component={FioAddressTransferFinishPage}
          excat
        />
        <PrivateRoute
          path={ROUTES.FIO_DOMAIN_TRANSFER_FINISH}
          component={FioDomainTransferFinishPage}
          excat
        />

...
export const PURCHASE_PROVIDE_PAYMENT_OPTION = {
  [PURCHASE_PROVIDER.FIO]: PAYMENT_OPTIONS.FIO,
  [PURCHASE_PROVIDER.STRIPE]: PAYMENT_OPTIONS.CREDIT_CARD,
  [PURCHASE_PROVIDER.CRYPTO]: PAYMENT_OPTIONS.CRYPTO,
};
...
export const PURCHASE_PROVIDER_PAYMENT_TITLE = {
  [PURCHASE_PROVIDER.FIO]: PAYMENT_OPTION_TITLE.FIO,
  [PURCHASE_PROVIDER.STRIPE]: PAYMENT_OPTION_TITLE.CREDIT_CARD,
  [PURCHASE_PROVIDER.CRYPTO]: PAYMENT_OPTION_TITLE.CRYPTO,
};

...
import classes from './FioDomainStatusChangeFinish.module.scss';

const FioDomainStatusChangeFinish: React.FC<ComponentProps> = props => {
  ...
  const title = !error ? 'Domain Status Changed!' : 'Domain Status Failed!';
  return (
...
export default FioDomainStatusChangeFinish;

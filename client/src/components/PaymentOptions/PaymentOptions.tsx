...
import { PAYMENT_OPTIONS, PURCHASE_PROVIDER } from '../../constants/purchase';
...
const PAYMENT_OPTIONS_PROPS = {
  [PAYMENT_OPTIONS.FIO]: ({
    ...
    disabled:
      ...
      loading ||
      disabled,
    provider: PURCHASE_PROVIDER.FIO,
    loading,
    hideButton: hasLowBalance,
    onClick: () => onPaymentChoose(PURCHASE_PROVIDER.FIO),
  }),
  [PAYMENT_OPTIONS.CREDIT_CARD]: ({
    ...
    provider: PURCHASE_PROVIDER.STRIPE,
    loading,
    onClick: () => onPaymentChoose(PURCHASE_PROVIDER.STRIPE),
  }),

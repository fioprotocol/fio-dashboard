...
import { ReferrerProfileApiToken } from './models/ReferrerProfileApiToken.mjs';
import { SearchTerm } from './models/SearchTerm.mjs';
import { TokenCode } from './models/TokenCode.mjs';
import { User } from './models/User';
import { UserDevice } from './models/UserDevice.mjs';
...
ReferrerProfileApiToken.init(sequelize);

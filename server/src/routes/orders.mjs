...
export default {
  ...
  updatePubKey: makeServiceRunner(OrderUpdatePubKey, req => ({
    ...req.params,
    ...req.body,
  })),
  processPayment: makeServiceRunner(OrderProcessPayment, req => ({
    ...req.params,
    ...req.body,
  })),
  getActive: makeServiceRunner(OrdersActive, req => req.query),
  get: makeServiceRunner(OrdersGet, req => req.params),
  cancel: makeServiceRunner(OrdersCancel, req => req.params),
};

...
export class WrapStatusPolygonWrapLogs extends Base {
  static init(sequelize) {
    super.init(
      ...
      {
        sequelize,
        tableName: 'wrap-status-polygon-wrap-logs',
        timestamps: false,
      },
    );
  }
  ...
  static async addLogs(data) {
    ...
    const query =
      'INSERT INTO "wrap-status-polygon-wrap-logs" ("transactionHash", "obtId", data) VALUES ' +
      data
        .map(() => {
          return '(?)';
        })
